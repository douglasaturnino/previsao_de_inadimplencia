...
nun_30_59 = st.sidebar.number_input(
...
num_emprestimos_ou_linhasImobiliarias = st.sidebar.slider(
...
numero_de_dependentes = st.sidebar.number_input(
...
predict_btn = st.button(
    "⏳Rodar Previsão 👈 clique aqui", use_container_width=True
)
...
if predict_btn:
    payload = {
        ...
        "Idade": idade,
        "NumeroDeVezes30_59DiasAtrasoNaoPior": nun_30_59,
        ...
        "NumeroDeEmprestimosOuLinhasImobiliarias": num_emprestimos_ou_linhasImobiliarias,
        "NumeroDeVezes60_89DiasAtrasoNaoPior": num_vezes_60_89_dias_atraso,
        "NumeroDeDependentes": numero_de_dependentes,
    }
    ...
    with st.spinner("Consultando o modelo."):
        try:
            ...
            if response.status_code == 200:
                ...
                if pred == 1:
                    risco = "🔴 Alto Risco"
                    texto = "### Chance do devedor não quitar a divida"
                    cor = "red"
                    pred = "inadimplente"
                else:
                    risco = "🟢 Baixo Risco"
                    texto = "### Chance do devedor quitar a divida"
                    cor = "green"
                ...
                st.write(
                    f"Resultado: **{pred}** com probabilidade **{probabilidade:.2%}**"
                )
